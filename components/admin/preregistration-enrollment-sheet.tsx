...
export function PreregistrationEnrollmentSheet({
  ...
  async function selectPreregistration(preregistration: ConvertiblePreregistration) {
    ...
    setDiscountCategories(discountCategoryOptions.filter((category) => category.cycleId === preregistration.targetCycleId && category.isActive))
  }
